        ...
        <div className="cv__education">
            ...
            <VerticalTimeline animate={true}>
                ...
                <VerticalTimelineElement
                    ...
                    <h3 className="vertical-timeline-element-title">Master Software Engineering and Information Systems</h3>
                ...
                <VerticalTimelineElement
                    ...
                    <p>The half year lasting system of courses focused on Java and J2EE (quick guide to Java, Swing,
                        Spring, EJB, Wicket, design patterns). After passing all courses and tests i had to create J2EE application
